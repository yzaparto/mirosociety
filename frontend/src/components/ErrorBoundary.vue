<template>
  <div v-if="error" class="min-h-[50vh] flex items-center justify-center px-6">
    <div class="text-center max-w-md">
      <div class="w-14 h-14 rounded-2xl bg-red-50 border border-red-300 flex items-center justify-center text-2xl mx-auto mb-4">!</div>
      <h2 class="text-lg font-semibold mb-2 text-slate-800">Something went wrong</h2>
